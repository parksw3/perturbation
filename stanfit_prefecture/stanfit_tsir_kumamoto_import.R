...
stanfit_tsir_kumamoto_import <- sampling(model,
                                         data = standata,
                                         seed=101)

save("stanfit_tsir_kumamoto_import", file="stanfit_tsir_kumamoto_import.rda")

ss <- summary(stanfit_tsir_kumamoto_import)

...
stanfit_tsir_kumamoto_constant <- sampling(model,
                                         data = standata,
                                         seed=101)

save("stanfit_tsir_kumamoto_constant", file="stanfit_tsir_kumamoto_constant.rda")

ss <- summary(stanfit_tsir_kumamoto_constant)

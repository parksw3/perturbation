...
Notably, we found robust, quadratic relationship between the estimated transmission rates and mean specific humidity across four major islands (Honshu, Shikoku, Kyushu, and Ryukyu), indicating low transmission at intermediate levels of specific humidity.
...
Intervention to slow the transmission of COVID-19 have disrupted the circulation of many pathogens \citep{baker2020impact}, including RSV epidemics in Japan.
...
Our analysis shows that interplay between climate-driven transmission and subtle changes in population-level susceptibility can cause sudden transition in epidemic dynamics.
Our results also highlight the importance of serological surveillance \citep{mina2020global,nguyen2022enterovirus}, which would have allowed us to directly measure changed in population-level susceptibility.

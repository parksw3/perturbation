...
\begin{flushleft}{
	\Large
	\textbf\newline{
	  Interplay between climate-driven transmission, childhood mixing, and population-level susceptibility explains a sudden shift in RSV seasonality in Japan
	}
}
\newline
\\

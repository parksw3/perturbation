...
\newline
\\
Sang Woo Park, Inga Holmdahl, Emily Howerton, Wenchang Yang, Rachel Baker, Gabriel A. Vecchi, Sarah Cobey, C. Jessica E. Metcalf, Bryan T. Grenfell
\bigskip
\end{flushleft}
...
We combined a parsimonious model of disease transmission with Bayesian statistical framework to infer RSV transmission dynamics across different islands.
...
This observation is also consistent \cite{baker2019epidemic} who predicted that an accumulation of the susceptible host population during the NPI period will eventually lead to a large outbreak.
...
Thus, we ware able to use the inferred dynamics to further tease apart the mechanisms underlying sudden changes in seasonality of the RSV outbreaks.
...
We hypothesize that an increase in childcare capacity through Comprehensive Support System for Children and Childcare may be a main driver of the increase in population-level susceptibility.

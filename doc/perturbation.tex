...
we estimated that transmission would peak at a low and high specific humidity (\fref{fig2}C).
...
The reduction in transmission rates caused an increase in the susceptible pool (\fref{fig2E}), which allowed a large outbreak when NPIs were lifted (\fref{fig2}A).
...
Other studies have also suggested the importance of interaction between RSV A and B as well as competition between RSV and human metapneumovirus \citep{white2005transmission}; 
...
Interventions to slow the transmission of COVID-19 have disrupted the circulation of many pathogens \citep{baker2020impact}, including RSV epidemics in Japan.
...
Our results also highlight the importance of serological surveillance \citep{mina2020global,nguyen2022enterovirus}, which would have allowed us to directly measure changes in population-level susceptibility.

...
Understanding how endogenous and exogenous factors shape population-level dynamics is a key aim in ecology.
Specifically, identifying mechanisms behind observed dynamical transitions in host-pathogen systems is crucial for predicting future outbreaks and making public health decisions.
In Japan, a sudden, dramatic shift in outbreak seasonality (from winter to fall) was observed in 2016 for respiratory syncytial virus (RSV), a major childhood respiratory pathogen.
Using mathematical modeling of RSV outbreaks, and inline with previous work, we found a robust quadratic relationship between mean specific humidity and transmission, with minimum transmission occurring at intermediate humidity.
This in turn causes semiannual patterns in seasonal transmission rates that peak in summer and winter.
In this case, a subtle increase in population-level susceptibility can cause sudden shift in seasonality, where the degree of shift is primarily determined by the lag between two peaks in seasonal transmission rate.
We tentatively hypothesize that an increase in children attending childcare facilities following the launch of the Comprehensive Support System for Children and Childcare in Japan may have contributed to the increase in susceptibility through increased contact rates.
Our analysis underlines the power of studying infectious disease dynamics for exploring dynamical transitions in ecology.

\pagebreak

\section*{Introduction}

Understanding the drivers of dynamical transitions is a fundamental challenge in ecology \citep{earn2000simple,hastings2004transients,hastings2018transient}.
...
In contrast to stable seasonality observed in other countries, a sudden, dramatic transition from winter to fall RSV outbreaks was observed in Japan in 2016 \citep{miyama2021seasonal,wagatsuma2021shifts}.
\cite{wagatsuma2021shifts} hypothesized that changes in climate and an increase in inbound overseas travelers may be both responsible for this shift in seasonality.
However, their conclusion relied on correlational analyses, providing weak, ecological support for their proposed mechanism.
Understanding the sudden shift in RSV seasonality is crucial to predicting future RSV outbreaks as well as for timely deployment of monoclonal antibodies and vaccination.

In this study, we analyzed the time series of RSV cases from Japan (\fref{fig1}) to infer the drivers of a sudden shift in seasonality between 2016 and 2017.
In doing so, we developed a flexible modeling approach to account for seasonal transmission and time-varying effects of non-pharmaceutical interventions (NPIs) that were introduced in response to the COVID-19 pandemic;
this study extends previous work by \cite{baker2020impact} who showed that the accumulation of susceptibles during the NPI period can cause a larger outbreak when NPIs are lifted.
...
We also found that these changes were associated with a shallowing of inter-epidemic troughs (\fref{fig1}C).

...
All data are stored in a publicly available GitHub repository (\url{https://github.com/parksw3/perturbation}).

\section*{Code availability}

All code are stored in a publicly available GitHub repository (\url{https://github.com/parksw3/perturbation}).
...
Lines represent the estimated median of the posterior distribution (n=8000 posterior samples).
Shaded regions represent the 95\% credible intervals from the posterior distribution (n=8000 posterior samples).

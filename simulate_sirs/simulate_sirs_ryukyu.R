...
load("../stanfit_sirs/stanfit_sirs_ryukyu_npi.rda")

ss <- summary(stanfit_sirs_ryukyu_npi)

pop <- filter(japan_pop_island, island=="Ryukyu")$pop
...
simulate_sirs_ryukyu <- simlist %>%
  bind_rows()

save("simulate_sirs_ryukyu", file="simulate_sirs_ryukyu.rda")
